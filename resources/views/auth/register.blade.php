                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('journal') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">اسم الكراسة</label>

                            <div class="col-md-6">
                                <input id="journal" type="text" class="form-control" name="journal" value="{{ old('journal') }}">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label for="password-confirm" class="col-md-4 control-label">كلمة السر تاني</label>
